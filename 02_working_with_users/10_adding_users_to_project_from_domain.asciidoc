...
GoodData.with_connection('user', 'password') do |client|
  GoodData.with_project('project_pid') do |project|
    ...
    project.import_users(users, domain: domain, whitelists: ['svarovsky@goodata.com'])
  end
end
----


The main workhorse here is the method `project.import_users`. What it takes is the list of users along with the roles. It also has to know which domain it is supposed to take these users from. 
