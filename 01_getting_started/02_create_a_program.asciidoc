...
1) Loads Automation SDK libraries
2) It logs you in and provides you the client as a `client` variable
3) It jacks into a project and provides you the project as a `project` variable
